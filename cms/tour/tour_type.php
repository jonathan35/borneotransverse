...
$attributes['tour_type'] = array('required' => 'required');
...
*/
$cols = $items =array();
$cols = array('Photo' => 3, 'Tour Type' => 3, 'SEO Keyword' => 2, 'SEO Description' => 2, 'Position' => 2);//Column title and width
